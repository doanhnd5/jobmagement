<div class="popularCardlist pb-2 slick-initialized slick-slider slick-dotted">
    <ul class="hot_job">
        @foreach ($jobWorkBasicList as $job)
        <li id="job-{{ $job['id'] }}"
                ...
                <div class="hot_job_img">
                    <figure>
                        <img
                            ...
                            secure_asset="{{ $job->image_name ? asset('image/uploaded/' . $job->image_name) : asset('image/uploaded/job_1.jpg') }} 87w, {{ $job->image_name ? asset('image/uploaded/' . $job->image_name) : asset('image/uploaded/job_1.jpg') }} 140w, {{ $job->image_name ? asset('image/uploaded/' . $job->image_name) : asset('image/uploaded/job_1.jpg') }} 155w"
