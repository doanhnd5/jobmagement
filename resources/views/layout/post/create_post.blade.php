        ...
        <form method="post" enctype="multipart/form-data" id="form">
            <div class="user-information bg-white p-4 py-5" id="formBox">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="txtPostContent" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $postData['post_content'] ?? "" }}</textarea>
                </div>
                <div class="mb-6">
                    <div class="flex items-center mb-1.5">
